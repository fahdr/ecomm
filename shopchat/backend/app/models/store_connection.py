...
for knowledge base synchronization.
...
For Project Managers:
    Store connections enable the "sync products to knowledge base"
    workflow. Users connect their store, then ShopChat imports
    product data to power AI-driven product recommendations.
...
For End Users:
    ...
    automatic product catalog sync for your AI chatbot.
    Supported platforms: Shopify, WooCommerce, and the dropshipping platform.
"""
