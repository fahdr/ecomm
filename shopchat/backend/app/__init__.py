"""
ShopChat Backend Service.

An independently hostable SaaS product providing AI Shopping Assistant.
...
For Developers:
    ...
    billing (Stripe), API key management, and the core shopchat features.

For Project Managers:
    This is the backend server that powers the ShopChat product.
