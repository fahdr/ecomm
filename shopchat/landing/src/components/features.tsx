 ...
 *
 * Displays 4 feature cards in a 2x2 grid (desktop) or stacked (mobile),
 ...
 *
 * **For QA Engineers:**
 *   - Verify all 4 cards render with correct icon, title, and description.
 ...
 *   - Features are fully config-driven. Adding a 5th feature is a one-line
 *     addition to `landing.config.ts`. The grid auto-adjusts.
 *
 * **For End Users:**
 *   - This section highlights the key capabilities that make the product valuable.
 *
 ...
 *
 * @param iconName - The icon key from landing.config.ts (e.g. "zap", "shield").
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="reveal mb-16 text-center">
          ...
          >
            Why choose{" "}
            <span className="gradient-text">{landingConfig.name}</span>?
          </h2>
          <p
            className="mx-auto max-w-2xl text-lg"
            style={{ color: "var(--landing-text-muted)" }}
          >
            Built for teams that demand the best. Here&apos;s what sets us apart.
          </p>
        </div>
