...
For Project Managers:
    Store connections enable the "import products" workflow. Users
    connect their Shopify/WooCommerce store, then pull product data
    for automatic caption generation and scheduling.

For QA Engineers:
    Test CRUD operations on connections. Verify that encrypted fields
    are never returned in plain text in API responses. Test cascading
    deletes when the owning user is removed.

For End Users:
    Connect your online store under the Connections tab to import
    products for automatic social media post generation. Supported
