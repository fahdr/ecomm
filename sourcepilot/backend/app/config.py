...
class Settings(BaseSettings):
    ...
    # Service identity
    service_name: str = "sourcepilot"
    service_display_name: str = "SourcePilot"
    service_port: int = 8109

    # Debug
    debug: bool = False

    # Database
    database_url: str = "postgresql+asyncpg://sourcepilot:sourcepilot_dev@localhost:5432/sourcepilot"
    database_url_sync: str = "postgresql://sourcepilot:sourcepilot_dev@localhost:5432/sourcepilot"
