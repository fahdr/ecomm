"""
SourcePilot Backend Service.

An independently hostable SaaS product providing Automated Supplier Product Import.
...
For Developers:
    ...
    billing (Stripe), API key management, and the core sourcepilot features.

For Project Managers:
    This is the backend server that powers the SourcePilot product.
