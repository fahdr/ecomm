"""
SpyDrop — FastAPI Application Entry Point.
...
For End Users:
    Access the API at http://localhost:8105/api/v1/
    Interactive docs at http://localhost:8105/docs
"""
...
app = FastAPI(
    ...
    description=f"REST API for {settings.service_display_name} — Competitor Intelligence",
    version="1.0.0",
    lifespan=lifespan,
)
