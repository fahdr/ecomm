"""
SpyDrop Backend Service.

An independently hostable SaaS product providing Competitor Intelligence.
...
For Developers:
    ...
    billing (Stripe), API key management, and the core spydrop features.

For Project Managers:
    This is the backend server that powers the SpyDrop product.
