"""
Plan tier definitions and limits for the SpyDrop service.
...
# SpyDrop plan limits
# max_items = competitors monitored, max_secondary = products tracked
PLAN_LIMITS: dict[PlanTier, PlanLimits] = {
    ...
    PlanTier.enterprise: PlanLimits(
        max_items=-1,          # Unlimited competitors
        max_secondary=-1,      # Unlimited products
