 ...
 * throughout the dashboard. They use the motion library (formerly
 * framer-motion) for spring-based, GPU-accelerated animations.
 *
 * **For Developers:**
 ...
 *   - All components accept standard div props and forward refs.
 *   - Import from: `import { FadeIn, StaggerChildren, AnimatedCounter } from "@/components/motion"`
 *
 * **For QA Engineers:**
 ...
 *   - Test stagger timing: children should appear sequentially, not all at once.
 *
 * **For End Users:**
 *   - Elements gracefully animate into view as you navigate the dashboard.
 *   - If you prefer no animations, enable "Reduce motion" in your OS settings.
 */
 ...
 * @returns An object with x and y offsets for the initial animation state.
 */
 ...
 *
 * Renders a motion.div that animates from transparent + offset to
 * fully visible at its natural position.
 *
 * @param props - FadeInProps (direction, delay, duration, className, children).
 ...
 *
 * Each child fades in from below with an incremental delay, creating
 ...
 * Use this at the top level of each page component for consistent route transitions.
 *
 ...
 * Useful for KPI cards, usage metrics, and billing summaries.
 *
...
export function AnimatedCounter({
  ...
  React.useEffect(() => {
    ...
    /**
     * Animation frame callback that applies an ease-out curve
     * to smoothly count from 0 to the target value.
     *
