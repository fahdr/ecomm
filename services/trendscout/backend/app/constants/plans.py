"""
Plan tier definitions and limits for the TrendScout service.
...
PLAN_LIMITS: dict[PlanTier, PlanLimits] = {
    PlanTier.free: PlanLimits(
        max_items=5,           # 5 research runs/mo
        max_secondary=25,      # 25 watchlist items
    ...
    PlanTier.pro: PlanLimits(
        max_items=50,          # 50 research runs/mo
        max_secondary=500,     # 500 watchlist items
    ...
    PlanTier.enterprise: PlanLimits(
        max_items=-1,          # Unlimited runs
        max_secondary=-1,      # Unlimited watchlist
