...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = "postgresql+asyncpg://trendscout:trendscout_dev@localhost:5432/trendscout"
    database_url_sync: str = "postgresql://trendscout:trendscout_dev@localhost:5432/trendscout"
