"""
{{SERVICE_DISPLAY_NAME}} — FastAPI Application Entry Point.
...
For End Users:
    Access the API at http://localhost:{{SERVICE_PORT}}/api/v1/
    Interactive docs at http://localhost:{{SERVICE_PORT}}/docs
"""
...
app = FastAPI(
    ...
    description=f"REST API for {settings.service_display_name} — {{SERVICE_TAGLINE}}",
    version="1.0.0",
    lifespan=lifespan,
)
...
# Add feature-specific routers below this line after scaffolding.
# Example:
