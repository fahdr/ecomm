"""
ShopChat — FastAPI Application Entry Point.
...
For End Users:
    Access the API at http://localhost:8108/api/v1/
    Interactive docs at http://localhost:8108/docs
"""
...
app = FastAPI(
    ...
    description=f"REST API for {settings.service_display_name} — AI Shopping Assistant",
    version="1.0.0",
    lifespan=lifespan,
)
...
# Feature-specific routers for ShopChat: chatbots, conversations,
# knowledge base, public widget, and analytics.
