...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = "postgresql+asyncpg://shopchat:shopchat_dev@localhost:5432/shopchat"
    database_url_sync: str = "postgresql://shopchat:shopchat_dev@localhost:5432/shopchat"
