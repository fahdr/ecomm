"""
Plan tier definitions and limits for the ShopChat service.
...
# ShopChat plan limits
# max_items = conversations/month, max_secondary = knowledge base pages
PLAN_LIMITS: dict[PlanTier, PlanLimits] = {
    PlanTier.free: PlanLimits(
        max_items=50,          # 50 conversations/mo
    ...
    PlanTier.pro: PlanLimits(
        max_items=1000,        # 1,000 conversations/mo
        max_secondary=500,     # Full catalog sync
