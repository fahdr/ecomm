...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = "postgresql+asyncpg://postpilot:postpilot_dev@localhost:5432/postpilot"
    database_url_sync: str = "postgresql://postpilot:postpilot_dev@localhost:5432/postpilot"
