"""
PostPilot Backend Service.

An independently hostable SaaS product providing Social Media Automation.
...
For Developers:
    ...
    billing (Stripe), API key management, and the core postpilot features.

For Project Managers:
    This is the backend server that powers the PostPilot product.
