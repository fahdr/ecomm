...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = "postgresql+asyncpg://adscale:adscale_dev@localhost:5432/adscale"
    database_url_sync: str = "postgresql://adscale:adscale_dev@localhost:5432/adscale"
