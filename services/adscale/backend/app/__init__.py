"""
AdScale Backend Service.

An independently hostable SaaS product providing AI Ad Campaign Manager.
...
For Developers:
    ...
    billing (Stripe), API key management, and the core adscale features.

For Project Managers:
    This is the backend server that powers the AdScale product.
