"""
Plan tier definitions and limits for the AdScale service.
...
# AdScale plan limits
# max_items = campaigns, max_secondary = ad groups
PLAN_LIMITS: dict[PlanTier, PlanLimits] = {
    PlanTier.free: PlanLimits(
        max_items=2,           # 2 campaigns
        max_secondary=5,       # 5 ad groups
    ...
    PlanTier.pro: PlanLimits(
        max_items=25,          # 25 campaigns
        max_secondary=100,     # 100 ad groups
    ...
    PlanTier.enterprise: PlanLimits(
        max_items=-1,          # Unlimited campaigns
        max_secondary=-1,      # Unlimited ad groups
