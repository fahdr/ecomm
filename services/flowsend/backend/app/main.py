"""
FlowSend — FastAPI Application Entry Point.
...
For End Users:
    Access the API at http://localhost:8104/api/v1/
    Interactive docs at http://localhost:8104/docs
"""
...
app = FastAPI(
    ...
    description=f"REST API for {settings.service_display_name} — Smart Email Marketing",
    version="1.0.0",
    lifespan=lifespan,
)
