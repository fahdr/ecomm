...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = "postgresql+asyncpg://flowsend:flowsend_dev@localhost:5432/flowsend"
    database_url_sync: str = "postgresql://flowsend:flowsend_dev@localhost:5432/flowsend"
