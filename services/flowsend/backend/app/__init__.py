"""
FlowSend Backend Service.

An independently hostable SaaS product providing Smart Email Marketing.
...
For Developers:
    ...
    billing (Stripe), API key management, and the core flowsend features.

For Project Managers:
    This is the backend server that powers the FlowSend product.
