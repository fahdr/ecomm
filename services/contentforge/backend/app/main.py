"""
ContentForge — FastAPI Application Entry Point.
...
For End Users:
    Access the API at http://localhost:8102/api/v1/
    Interactive docs at http://localhost:8102/docs
"""
...
async def lifespan(app: FastAPI):
    ...
    Initializes Stripe price IDs and seeds system templates on startup.
    """
...
app = FastAPI(
    ...
    description=f"REST API for {settings.service_display_name} — AI Product Content Generator",
    version="1.0.0",
    lifespan=lifespan,
)
