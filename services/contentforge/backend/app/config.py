...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = "postgresql+asyncpg://contentforge:contentforge_dev@localhost:5432/contentforge"
    database_url_sync: str = "postgresql://contentforge:contentforge_dev@localhost:5432/contentforge"
