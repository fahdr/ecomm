"""
Plan tier definitions and limits for the RankPilot service.
...
# RankPilot plan limits
# max_items = blog posts/month, max_secondary = keywords tracked
PLAN_LIMITS: dict[PlanTier, PlanLimits] = {
    PlanTier.free: PlanLimits(
        max_items=2,           # 2 blog posts/mo
        max_secondary=20,      # 20 keywords tracked
    ...
    PlanTier.pro: PlanLimits(
        max_items=20,          # 20 blog posts/mo
        max_secondary=200,     # 200 keywords
    ...
    PlanTier.enterprise: PlanLimits(
        ...
        max_secondary=-1,      # Unlimited keywords
