"""
RankPilot — FastAPI Application Entry Point.
...
For End Users:
    Access the API at http://localhost:8103/api/v1/
    Interactive docs at http://localhost:8103/docs
"""
...
app = FastAPI(
    ...
    description=f"REST API for {settings.service_display_name} — Automated SEO Engine",
    version="1.0.0",
    lifespan=lifespan,
)
...
# Feature routers for RankPilot SEO engine (sites, keywords, audits,
# blog posts, and JSON-LD schema markup).
from app.api.sites import router as sites_router
from app.api.keywords import router as keywords_router
from app.api.audits import router as audits_router
from app.api.blog_posts import router as blog_posts_router
