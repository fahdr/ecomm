...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = "postgresql+asyncpg://rankpilot:rankpilot_dev@localhost:5432/rankpilot"
    database_url_sync: str = "postgresql://rankpilot:rankpilot_dev@localhost:5432/rankpilot"
