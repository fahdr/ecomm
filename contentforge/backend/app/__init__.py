"""
ContentForge Backend Service.

An independently hostable SaaS product providing AI Product Content Generator.
...
For Developers:
    ...
    billing (Stripe), API key management, and the core contentforge features.

For Project Managers:
    This is the backend server that powers the ContentForge product.
