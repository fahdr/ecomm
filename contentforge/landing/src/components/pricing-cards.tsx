 ...
 *
 * Displays pricing tiers (typically Free, Pro, Enterprise) as cards with:
 * - Tier name and price
 ...
 *   - Price of 0 shows "Free", price of -1 shows "Custom" (for enterprise).
 ...
 *
 * **For QA Engineers:**
 *   - Verify correct pricing display: $0 -> "Free", $29 -> "$29/mo", -1 -> "Custom".
 *   - Check that the "Most Popular" badge renders only on the flagged tier.
            ...
            >
              ...
              >
                ...
                <div className="mb-6 flex items-baseline gap-1">
                  <span
                    className="text-4xl font-extrabold tracking-tight font-heading"
                    style={{
                      color:
                        tier.popular
