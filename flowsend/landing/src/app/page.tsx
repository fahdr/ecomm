/**
 * Main landing page — composes all sections into a single scroll experience.
 *
 * This is the homepage (`/`) that visitors see first. It assembles:
 * 1. Navbar (sticky, transparent -> glass on scroll)
 * 2. Hero section (full viewport, animated headline + illustration)
 * 3. Stats bar (social proof numbers with count-up)
 * 4. Features grid (4 cards, 2x2 layout)
 ...
 *   - This page requires zero code changes between services.
 *   - All customization happens in `landing.config.ts`.
 *   - The page is statically exported for CDN hosting.
 *
 * **For End Users:**
 *   - Scroll down to explore the product features, pricing, and more.
