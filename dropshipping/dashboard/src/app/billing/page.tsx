...
/**
 * Skeleton loading state for the billing page content.
 *
 ...
 *
 * @returns The billing page wrapped in AuthenticatedLayout and Suspense.
 */
...
function BillingContent() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 px-6 py-12">
      <PageTransition>
        {showSuccess && (
          <div className="rounded-md border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-800 dark:border-green-800 dark:bg-green-950 dark:text-green-200 mb-6">
        ...
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>
              You are on the{" "}
              <span className="font-medium">{billing.plan_name}</span> plan.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {billing.subscription && (
