"""
{{SERVICE_DISPLAY_NAME}} Backend Service.

An independently hostable SaaS product providing {{SERVICE_TAGLINE}}.
...
For Developers:
    ...
    billing (Stripe), API key management, and the core {{SERVICE_NAME}} features.

For Project Managers:
    This is the backend server that powers the {{SERVICE_DISPLAY_NAME}} product.
