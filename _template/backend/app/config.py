...
class Settings(BaseSettings):
    ...
    service_display_name: str = "{{SERVICE_DISPLAY_NAME}}"
    ...
    # Database
    database_url: str = "postgresql+asyncpg://{{SERVICE_NAME}}:{{SERVICE_NAME}}_dev@localhost:5432/{{SERVICE_NAME}}"
    database_url_sync: str = "postgresql://{{SERVICE_NAME}}:{{SERVICE_NAME}}_dev@localhost:5432/{{SERVICE_NAME}}"
    ...
    # CORS
    cors_origins: str = "http://localhost:{{DASHBOARD_PORT}}"
    ...
    stripe_billing_success_url: str = "http://localhost:{{DASHBOARD_PORT}}/billing?success=true"
    stripe_billing_cancel_url: str = "http://localhost:{{DASHBOARD_PORT}}/billing?canceled=true"
