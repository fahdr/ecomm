...
For Project Managers:
    ...
    connect their Shopify/WooCommerce store, then AdScale can pull
    product data to automatically generate ad campaigns.
...
For End Users:
    ...
    automatic product import for ad campaign creation.  Supported
